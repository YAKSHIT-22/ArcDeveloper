...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    ...
    if(total){
      if(category){
        mailOptions = {from: "Firebase Nodemailer",
        to: "",
        subject: "Estimate Recevied!",
        html: `
        ...
        html: `
          ...
          <p style="font-size: 16px>Total: ${total}</p>
          <p style="font-size: 16px>Service: ${service}</p>
          <p style="font-size: 16px>Platfroms: ${platforms}</p>
          <p style="font-size: 16px>Feature: ${features}</p>
      ...
      transporter.sendMail(mailOptions, (error) =>{
        if (error) {
          ...
          response.send("Message sent Success");
        }
      });
      mailOptions = {from: "Firebase Nodemailer",
      to: email,
